...
function TopArea(){
	...
	document.write('<li><a href="../../html/rule/rule0101.html">웹가이드</a></li>');
	document.write('<li><a href="../../html/mobile/rule0101.html">모바일가이드</a></li>');
...
//	document.write('		<h2 class="lnbtit">LNB 타이틀</h2>');
	...
	document.write('				</ul>');
	document.write('			</li>');
	document.write('			<li><a href="#">레이아웃가이드</a>');
	document.write('				<ul class="lnb2depth">');
	document.write('					<li><a href="rule0201.html">레이아웃</a></li>');
	document.write('					<li><a href="rule0202.html">메뉴(GNB, LNB)</a></li>');
	document.write('					<li><a href="rule0203.html">레이어팝업</a></li>');
	document.write('				</ul>');
	document.write('			</li>');	
...
/*	document.write('			<li><a href="rule0601.html">CSS / JS 가이드</a></li>');*/
	document.write('			<li><a href="rule0801.html">텍스트 가이드</a></li>');	
	document.write('			<li><a href="rule0901.html">탭/버튼 가이드</a></li>');		
	document.write('			<li><a href="rule1001.html">박스(Grid)형태 가이드</a></li>');		
