$(document).ready(function(){
  ...
  var mainContentSpace = $wrapSlider.height() / 5

  $('.main .title').css('top', mainContentSpace)
  $('.main .wrap_btn').css('bottom', mainContentSpace)
  ...
  var slider = setInterval(function(){
    ...
    $wrapSlide.animate({
      ...
      $slide.each(function(){
        ...
        var index = $this.attr('data-index-number') - 1

        if (index < 0) {
          index = $slide.length - 1
        }

        $this.css('left', index * $window.width()).attr('data-index-number', index)
      })
    })
  }, 5000)
